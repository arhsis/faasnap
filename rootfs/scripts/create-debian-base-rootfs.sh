...
sudo debootstrap --include openssh-server,nano,vim,ffmpeg,libjpeg-dev,zlib1g-dev,tcpdump,build-essential,pkg-config,python3,python3-pip,python3-setuptools,python3-dev,gcc,libpq-dev,python3-dev,python3-venv,python3-wheel,curl $DEBIAN_VERSION mountpoint http://ftp.cn.debian.org/debian/
